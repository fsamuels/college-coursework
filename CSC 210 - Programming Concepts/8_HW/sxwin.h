...
// 25 Apr 2000 - added a function to draw several lines of text (MS)
...
public:
  ...
  void drawText(int x, int y, String text[], int num_lines,
                int padding = 2, double spacing = 1.0);
  // clears an area big enough to hold the given text (each row of the
  // array represents a line) and prints it with the given spacing ratio
  // using font information; (x,y) is the upper-left corner of the area to
  // be cleared; padding is the amount of extra space (in pixels) around
  // the border

  void textSize(int & width, int & height, String text[], int num_lines,
                int padding = 2, double spacing = 1.0) const;
  // used to find the width and height of the area containing a block of
  // text to be drawn by drawText
